    ...
    link: function ($scope, element, attrs, ctrl) {
      ...
      $scope.$watch(element.html(), function (value) {
        if (!$scope.hasEllipsis) {
          ...
          $(element).trunk8({
            fill: ' <a id="read-more"><i class="icon ion-more"></i></a>', /*(Default: '&hellip;') The string to insert in place of the omitted text. This value may include HTML.*/
            lines: 2, /*(Default: 1) The number of lines of text-wrap to tolerate before truncating. This value must be an integer greater than or equal to 1.*/
